...
echo ""
$PYJAMA --pull -m llama3.2 -p "Write a haiku about coding"
echo ""
echo ""
read -p "Press Enter to continue..."
clear
...
echo ""
$PYJAMA --pull -m llama3.2 -s false -p "What is 2+2?"
echo ""
read -p "Press Enter to continue..."
clear
...
echo ""
$PYJAMA --pull -m llava -i image.jpg -p "Describe this image in detail"
echo ""
echo ""
read -p "Press Enter to continue..."
clear
...
echo ""
$PYJAMA --pull -o $SCRIPT_DIR/../../demo_art.png -w 256 -g 256 -p "A futuristic robot"
echo ""
...
echo ""
$PYJAMA --pull -m llama3.2 -o $SCRIPT_DIR/../../demo_response.md -p "Explain functional programming in one paragraph"
echo ""
