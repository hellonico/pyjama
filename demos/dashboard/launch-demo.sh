...
clj -J-Dagents.edn=demos/dashboard/agents -M:pyjama run hello-world "{\"output-dir\": \"$OUTPUT_DIR\"}" > "$OUTPUT_DIR/hello-world.log" 2>&1 &
AGENT1_PID=$!
...
clj -J-Dagents.edn=demos/dashboard/agents -M:pyjama run file-counter "{\"output-dir\": \"$OUTPUT_DIR\"}" > "$OUTPUT_DIR/file-counter.log" 2>&1 &
AGENT2_PID=$!
...
clj -J-Dagents.edn=demos/dashboard/agents -M:pyjama run poem-writer "{\"output-dir\": \"$OUTPUT_DIR\"}" > "$OUTPUT_DIR/poem-writer.log" 2>&1 &
AGENT3_PID=$!
...
clj -J-Dagents.edn=demos/dashboard/agents -M:pyjama run quick-math "{\"output-dir\": \"$OUTPUT_DIR\"}" > "$OUTPUT_DIR/quick-math.log" 2>&1 &
AGENT4_PID=$!
...
clj -J-Dagents.edn=demos/dashboard/agents -M:pyjama run code-snippet "{\"output-dir\": \"$OUTPUT_DIR\"}" > "$OUTPUT_DIR/code-snippet.log" 2>&1 &
AGENT5_PID=$!
